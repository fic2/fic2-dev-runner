...
exports.OAuth2.prototype.getAuthorizeUrl= function() {
  var state = Math.floor(Math.random() * (Math.pow(2, 53) - 1));
  return this._baseSite + this._authorizeUrl + '?response_type=code&client_id=' + this._clientId + '&state=' + state + '&redirect_uri=' + this._callbackURL;
}
